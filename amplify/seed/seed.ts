...
const testOrders: SeedOrder[] = [
  ...
  {
    id: "seed-order-manchester-paid",
    orderNumber: "BB-TEST-1002",
    status: "preparing",
    paymentStatus: "paid",
    customerEmail: "manchester.test@example.com",
    customerPhone: "+442079460102",
    firstName: "Maya",
    lastName: "Manchester",
    fulfilmentMethod: "manchester",
    addressLine1: "22 Northern Quarter",
    addressLine2: "Flat 4",
    city: "Manchester",
    postcode: "M1 1AD",
    customerNotes: "Same-day delivery after 4pm.",
    deliveryFeeInPence: 250,
    loyaltySpendInPence: 1800,
    stampsEarned: 2,
    rewardDiscountInPence: 500,
    stripePaymentIntentId: "pi_test_butter_manchester",
    items: [
      {
        id: "seed-order-manchester-paid-item-banana",
        productId: "banana-pudding",
        variantId: "banana-pudding-classic",
        quantity: 2,
      },
      {
        id: "seed-order-manchester-paid-item-brookies",
